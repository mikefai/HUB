...
1. $\$80 \to \$100$: $(100 - 80)/80 = 25\%$ increase.
2. Values $6(\times 5)$, $4(\times 3)$, $14(\times 2)$: mean $= 70/10 = 7$.
3. $60$ mph $= 60 \cdot 5280/3600 = 88$ ft/s.

## Common Traps

- Dividing by the new value instead of the old in percent change.
- Averaging group means without weighting by group size.
- Using the grand total as denominator in conditional probability.
- Confusing median (middle value) with mean, or range with IQR.

## Self-Check (answers in the drills)

- Ratio $3:4$, sum $63$: smaller number? *(27)*
- Bag has 4 red, 5 blue, 11 green: P(blue)? *(1/4)*
- $y = 5x + 60$ predicts what at $x = 7$? *(95)*
