...
- **Isolate step by step**: undo addition/subtraction first, then multiplication/division. Whatever you do to one side, do to the other.
- **Flipping rule**: multiplying or dividing an inequality by a negative number reverses the sign ($<$ becomes $>$).
...
1. $3x + 7 = 22 \Rightarrow 3x = 15 \Rightarrow x = 5$.
2. System $y = 2x + 3$, $y = -x + 9$: set equal, $2x + 3 = -x + 9 \Rightarrow x = 2$, so $y = 7$.
3. $-2x + 5 \ge 11 \Rightarrow -2x \ge 6 \Rightarrow x \le -3$ (sign flipped).
